                ...
                <div className="container-fluid">
                    ...
                    <div className="d-flex">
                        <div className={end}>
                            <div className="dropdown userAccountAdp">
                                ...
                                <ul className="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                                    <li> <NavLink className="dropdown-item" to="/personal">Личный кобинет</NavLink></li>
                                    <li> <NavLink className="dropdown-item" to="/news">Новости</NavLink></li>
                                    <li><NavLink className="dropdown-item" to="/students">Ученики</NavLink></li>
                        ...
                        <span className="voyt">
                            ...
                            <a onClick={Btnaccount}  type="button" className="btn fh" data-bs-toggle="modal"
