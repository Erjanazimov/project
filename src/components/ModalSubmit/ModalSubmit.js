...
import {submitChange, submitStudents} from "../../redux/actions";
...
function ModalSubmit(){
    ...
    let [closeModal, SetcloseModal] = useState("")
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button onClick={btnSumbmit} type="button" className="btn btn-primary" data-bs-dismiss={closeModal}>Отправить</button>
                    </div>
                </div>
            </div>
        </div>
